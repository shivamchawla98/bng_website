  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundAttachment: 'fixed', // Fixed background like login page
      }}
    >
      ...
      <div
        ...
        style={{
          opacity: 0.90, // Matches login page's opacity-95
        }}
      >
        {/* Top-right Patch */}
        <div
        ...
        <div
          ref={sectionRef}
          className="flex flex-col justify-center w-[100%] px-4 overflow-x-hidden py-14 relative z-10"
        >
            ...
            <div className="relative" style={{ minHeight: "800px" }}>
              ...
              <div
                ...
                style={{
                  ...
                  borderStyle: "dashed",
                  borderImage:
                    "repeating-linear-gradient(to bottom , oklch(70.4% 0.04 256.788), oklch(70.4% 0.04 256.788) 16px, transparent 10px, transparent 20px) 1",
                }}
              />
