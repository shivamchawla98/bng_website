    ...
    <div className=" bg-secondryBg px-4 md:px-[112px]  flex flex-col md:flex-row items-center justify-center gap-16 ">
      ...
      <div className="md:w-1/2 md:pr-10 mb-8 md:mb-0 md:ml-10 mt-10 md:mt-0 py-14 ">
        <div className="relative">
          <h2 className="text-[60px] font-bold mb-4 text-gray-700 relative z-10">
            Our <span className="text-[#46349a]">Story</span>
          </h2>
          <h2
        ...
        <button onClick={() => router.push("/our-company")} className="group bg-[#46349a] rounded-lg text-white px-6 py-3 cursor-pointer flex items-center hover:bg-primary hover:from-transparent transition-all duraton-300  transform hover:translate-x-2" >
          Know more
          <svg
