  ...
  return (
    ...
    >
      ...
      <form className="max-w-2xl mx-auto">
        <div className="flex md:w-[600px] shadow-md overflow-hidden border border-gray-300 rounded-lg">
          {/* Dropdown Button */}
          <button
            id="dropdown-button"
            onClick={toggleDropdown}
            className="flex-shrink-0 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-white bg-primary focus:ring-4 focus:outline-none bg-gradient-to-tr from-[#6853DB] to-[#6853DB]"
            type="button"
          >
            {selectedOption}
            <svg
              ...
              >
                <li>
                  <button
                    ...
                    className="inline-flex w-full px-4 py-2 bg-gradient-to-tr from-[#6853DB] to-[#6853DB] dark:hover:text-white"
                  >
                    Country
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className="inline-flex w-full px-4 py-2 bg-gradient-to-tr from-[#6853DB] to-[#6853DB]"
                  >
                    Specific Member
                  </button>
                </li>
          ...
          <div className="relative w-full">
            <input
              type="search"
              id="search-dropdown"
              className="block w-full py-2.5 px-4 text-sm text-gray-900 bg-white border-none focus:ring-0 placeholder-gray-400 rounded-lg"
            ...
            <button
              type="submit"
              className="absolute inset-y-0 right-0 flex items-center justify-center px-4 bg-gradient-to-tr from-[#6853DB] to-[#6853DB] rounded-lg text-white text-sm font-medium hover:bg-primary/90"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
