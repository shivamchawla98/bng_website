...
const BlogCategoryClient = ({ slug }) => {
  ...
  const handlePageChange = (newPage) => {
    ...
    router.push(`/blog/category/${slug}${queryString ? `?${queryString}` : ''}`, { scroll: false });
  ...
  const breadcrumbs = category
    ? generateBreadcrumbs(`/blog/category/${slug}`, { categoryName: category.name })
    : [];
