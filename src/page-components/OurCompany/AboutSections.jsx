        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12 mb-12">
          ...
          <div className="flex flex-col justify-center items-center lg:items-start gap-8">
            ...
            <p className="text-gray-500 text-base leading-relaxed text-center lg:text-start">
              ...
              blend tradition with technology, crafting solutions that are both
              cutting-edge and timeless. Our team is committed to delivering
              excellence in every project, big or small, ensuring client
              satisfaction is at the forefront of our mission. With a wealth of
              experience across various industries, we’ve built a reputation for
              quality, trust, and outstanding results. Join us on a journey to
              redefine what's possible in the world of business and construction{" "}
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12 mb-12">
          ...
          <div className="flex flex-col justify-center items-center lg:items-start gap-8">
            <p className="text-gray-500 text-base leading-relaxed text-center lg:text-start">
              ...
              communication, transparency, and collaboration, ensuring that each
              project exceeds expectations. By fostering strong relationships,
              we’ve created a loyal clientele who trusts us to handle their most
              challenging ventures. Your success is our priority, and we strive
              to be your partner in achieving greatness.{" "}
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12">
          ...
          <div className="flex flex-col justify-center items-center lg:items-start gap-8">
            ...
            <p className="text-gray-500 text-base leading-relaxed text-center lg:text-start">
              ...
              technology and sustainability, we aim to build a legacy that will
              inspire future generations. We envision a world where our work
              enhances communities and drives positive change globally.{" "}
            </p>
          </div>
        </div>
