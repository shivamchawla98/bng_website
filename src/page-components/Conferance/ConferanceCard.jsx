...
export const ConferenceCard = ({ date, description, index, totalCards }) => {
  ...
  return (
    <div
      className={`rounded-lg shadow-md overflow-hidden text-[#27293B] ${cardPosition}`}>
      <Image src={conferance1} alt="Conference" className="w-full" />
      <div className="p-6">
        <p className={`font-semibold mb-2 text-[#27293B]}`}>{date}</p>
