...
export default function IncotermsPage() {
  ...
  return (
    <>
          <Head>
        <title>Incoterms 2024 Guide | BNG Logistics Network</title>
        <meta
          name="description"
          content="Understand global Incoterms with BNG’s updated guide. Simplify your freight contracts and international shipping responsibilities with ease."
        />
      </Head>
      <div className="flex flex-col md:flex-row min-h-screen">
      {/* Sidebar Navigation - Updated with sober styling */}
      <aside className="w-full md:w-[256px] pb-6 bg-white p-4 md:fixed md:top-[102px]  md:h-screen z-10 border-r border-gray-200">
  {/* Fixed Header */}
