...
const TermsOfUse = () => {
  return (
    <div className="bg-gray-50 min-h-screen p-8">
      <div className="max-w-4xl mx-auto text-gray-600 bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 text-center">TERMS OF USE</h1>

        <p className="mb-4">
          The BNG LOGISTICS NETWORK website located at{' '}
          <a href="http://www.bnglogisticsnetwork.com" className="text-blue-500 hover:underline">
            http://www.bnglogisticsnetwork.com
          </a>{' '}
          is a copyrighted work belonging to BNG INFO MEDIA AND TECHNOLOGIES LLP. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.
        </p>
        ...
        <p className="mb-4">
          ...
          <a href="https://www.termsofusegenerator.net/" className="text-blue-500 hover:underline">
            Terms Of Use Generator
          </a>{' '}
          and the{' '}
          <a href="https://www.generateprivacypolicy.com/" className="text-blue-500 hover:underline">
            Privacy Policy Generator
          </a>.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">ACCESS TO THE SITE</h2>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Certain Restrictions</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">No Support or Maintenance</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">User Content</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Acceptable Use Policy</h3>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">THIRD-PARTY LINKS & ADS AND OTHER USERS</h2>

        <h3 className="text-xl font-bold mt-6 mb-4">Third-Party Links & Ads</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Other Users</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Cookies and Web Beacons</h3>

        <p className="mb-4">
          Like any other website, go2bng.com uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Google DoubleClick DART Cookie</h3>

        <p className="mb-4">
          Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL –{' '}
          <a href="https://policies.google.com/technologies/ads" className="text-blue-500 hover:underline">
            https://policies.google.com/technologies/ads
          </a>.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Our Advertising Partners</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Applicability of Arbitration Agreement</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Notice Requirement and Informal Dispute Resolution</h3>

        <p className="mb-4">
          Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: “NOIDA ONE” UNIT C-321, 3RD FLOOR, TOWER - C, PLOT NO. B-8, IT PARK, SECTOR -62, NOIDA-201309, UTTAR PRAESH INDIA. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Arbitration Rules</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Additional Rules for Non-Appearance Based Arbitration</h3>

        <p className="mb-4">
          If non-appearance based arbitration is elected, the arbitration shall be conducted by telephone, online and/or based solely on written submissions; the specific manner shall be chosen by the party initiating the arbitration. The arbitration shall not involve any personal appearance by the parties or witnesses unless otherwise agreed by the parties.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Time Limits</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Authority of Arbitrator</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Waiver of Jury Trial</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Claims Not Subject to Arbitration</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Electronic Communications</h3>

        <p className="mb-4">
          The communications between you and Company use electronic means, whether you use the Site or send us emails, or whether Company posts notices on the Site or communicates with you via email. For contractual purposes, you (a) consent to receive communications from Company in an electronic form; and (b) agree that all terms and conditions, agreements, notices, disclosures, and other communications that Company provides to you electronically satisfy any legal obligation that such communications would satisfy if it were be in a hard copy writing.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Entire Terms</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Your Privacy</h3>

        <p className="mb-4">
          Please read our Privacy Policy.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Copyright/Trademark Information</h3>
        ...
        <p className="mb-4">
          You may direct questions, comments or reports to: BNG INFO MEDIA AND TECHNOLOGIES LLP
        </p>

        <p className="mb-4">
          EMAIL:{' '}
          <a href="mailto:INFO@BNGLOGISTICSNETWORK.COM" className="text-blue-500 hover:underline">
            INFO@BNGLOGISTICSNETWORK.COM
          </a>
          ,{' '}
          <a href="mailto:MEMBERSHIPS@BNGLOGISTICSNETWORK.COM" className="text-blue-500 hover:underline">
