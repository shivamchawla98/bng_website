    ...
    <div className='m-6 max-w-4xl mx-auto'>
      ...
      <div className='space-y-6 text-gray-700'>
        <p className='text-base leading-relaxed'>
          ...
          <a href='http://www.bnglogisticsnetwork.com' className='text-blue-600 hover:underline'>
        ...
        <p className='text-base leading-relaxed'>
          ...
          <a href='https://www.termsofusegenerator.net/' className='text-blue-600 hover:underline'>
            Terms Of Use Generator
          </a>{' '}
          and the{' '}
          <a href='https://www.generateprivacypolicy.com/' className='text-blue-600 hover:underline'>
            Privacy Policy Generator
          </a>.
        </p>

        <h2 className='text-xl text-gray-800 font-semibold mt-8 mb-4'>
          ACCESS TO THE SITE
        </h2>
        <p className='text-base leading-relaxed'>
        ...
        <h3 className='text-lg text-gray-800 font-semibold mt-6 mb-3'>
        ...
        <p className='text-base leading-relaxed'>
          EMAIL:{' '}
          <a href='mailto:INFO@BNGLOGISTICSNETWORK.COM' className='text-blue-600 hover:underline'>
            INFO@BNGLOGISTICSNETWORK.COM
          </a>
          ,{' '}
          <a href='mailto:MEMBERSHIPS@BNGLOGISTICSNETWORK.COM' className='text-blue-600 hover:underline'>
