...
<p className="text-lg text-gray-700">Subscribe to stay updated</p>
<div className="mt-6 w-full border-b-[0.9px] flex flex-col gap-y-4 items-center   rounded-full">
<input
type="email"
className="rounded-lg p-2 w-full bg-white border-primary"
placeholder="Enter your email"
/>
<button className="p-2 py-[12px] flex justify-center items-center font-medium gap-x-3 w-full ml-2 bg-gradient-to-tr from-[#6853DB] to-[#6853DB] text-white border-white rounded-lg">
Subscribe!
<svg
width="23"
height="16"
...
<div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 mt-8 lg:ml-10 md:mt-8 md:w-3/4">
<FooterSection
title="ABOUT US"
links={[
{ href: "#", label: "FAQ's" },
