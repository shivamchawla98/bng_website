      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-primary">
            ...
            <FooterSection title="Follow us" links={[
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center text-primary">
            © 2023 <a href="https://google.com/" className="hover:underlin te">BNG™</a>. All Rights Reserved.
          </span>
          <SocialLinks />
        </div>
      </div>
...
const SocialLinks = () => (
  <div className="flex mt-4 sm:justify-center sm:mt-0">
    {socialMediaLinks.map((social, index) => (
      <a key={index} href={social.href} className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
