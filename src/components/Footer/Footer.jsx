      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:pt-10 lg:pb-0 relative z-10">
        <div className="md:flex md:justify-between gap-8">
          <div className="mt-6 md:mb-2 md:w-1/4">
            {(pathname !== "/incoterms" && pathname !== "/dgr" && pathname !== "/uld") && ( // Conditionally render based on route
              <>
                <SocialLinks />
                <div className="">
                  <p className="text-3xl font-semibold text-gray-700">
                    Subscribe <span className="font-medium"> to stay Updated </span>
                  </p>
                  <div className="mt-6 w-full border-b-[0.9px] flex flex-col gap-y-4 items-center rounded-full">
                    <input
                      type="email"
                      className="rounded-lg p-[16px] w-full bg-white border-primary"
